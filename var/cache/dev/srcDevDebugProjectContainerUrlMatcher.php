...
class srcDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/l')) {
            ...
            // cerrarSesion
            if ('/logout' === $pathinfo) {
                return array (  '_controller' => 'App\\Controller\\SecurityController::logout',  '_route' => 'cerrarSesion',);
            }
        ...
        // app_security_login
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'App\\Controller\\SecurityController::login',  '_route' => 'app_security_login',);
            if ('/' === substr($pathinfo, -1)) {
                // no-op
            } elseif ('GET' !== $canonicalMethod) {
                goto not_app_security_login;
            } else {
                return array_replace($ret, $this->redirect($rawPathinfo.'/', 'app_security_login'));
            }

            return $ret;
        }
        not_app_security_login:
